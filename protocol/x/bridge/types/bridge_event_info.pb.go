...
// source: jinxprotocol/bridge/bridge_event_info.proto
...
func (*BridgeEventInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_d0424f65d10e5a0d, []int{0}
}
...
func init() {
	proto.RegisterType((*BridgeEventInfo)(nil), "jinxprotocol.bridge.BridgeEventInfo")
}

func init() {
	proto.RegisterFile("jinxprotocol/bridge/bridge_event_info.proto", fileDescriptor_d0424f65d10e5a0d)
}

var fileDescriptor_d0424f65d10e5a0d = []byte{
	// 208 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xd2, 0xce, 0xca, 0xcc, 0xab,
	...
	0x4b, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xbf, 0xd1, 0x73, 0xfc, 0xf4, 0x00, 0x00, 0x00,
}
