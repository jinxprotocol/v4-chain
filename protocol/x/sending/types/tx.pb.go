...
// source: jinxprotocol/sending/tx.proto
...
func (*MsgCreateTransfer) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc4ec2af3b852647, []int{0}
}
...
func (*MsgCreateTransferResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc4ec2af3b852647, []int{1}
}
...
func (*MsgDepositToSubaccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc4ec2af3b852647, []int{2}
}
...
func (*MsgWithdrawFromSubaccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc4ec2af3b852647, []int{3}
}
...
func (*MsgSendFromModuleToAccountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc4ec2af3b852647, []int{4}
}
...
func init() {
	proto.RegisterType((*MsgCreateTransfer)(nil), "jinxprotocol.sending.MsgCreateTransfer")
	proto.RegisterType((*MsgCreateTransferResponse)(nil), "jinxprotocol.sending.MsgCreateTransferResponse")
	proto.RegisterType((*MsgDepositToSubaccountResponse)(nil), "jinxprotocol.sending.MsgDepositToSubaccountResponse")
	proto.RegisterType((*MsgWithdrawFromSubaccountResponse)(nil), "jinxprotocol.sending.MsgWithdrawFromSubaccountResponse")
	proto.RegisterType((*MsgSendFromModuleToAccountResponse)(nil), "jinxprotocol.sending.MsgSendFromModuleToAccountResponse")
}

func init() { proto.RegisterFile("jinxprotocol/sending/tx.proto", fileDescriptor_dc4ec2af3b852647) }

var fileDescriptor_dc4ec2af3b852647 = []byte{
	// 349 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcd, 0xca, 0xcc, 0xab,
	...
	0x00, 0x00, 0x00, 0xff, 0xff, 0x82, 0x89, 0x4a, 0xf2, 0x8e, 0x03, 0x00, 0x00,
}
...
func (c *msgClient) CreateTransfer(ctx context.Context, in *MsgCreateTransfer, opts ...grpc.CallOption) (*MsgCreateTransferResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.sending.Msg/CreateTransfer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DepositToSubaccount(ctx context.Context, in *MsgDepositToSubaccount, opts ...grpc.CallOption) (*MsgDepositToSubaccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.sending.Msg/DepositToSubaccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawFromSubaccount(ctx context.Context, in *MsgWithdrawFromSubaccount, opts ...grpc.CallOption) (*MsgWithdrawFromSubaccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.sending.Msg/WithdrawFromSubaccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SendFromModuleToAccount(ctx context.Context, in *MsgSendFromModuleToAccount, opts ...grpc.CallOption) (*MsgSendFromModuleToAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.sending.Msg/SendFromModuleToAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.sending.Msg/CreateTransfer",
	}
...
func _Msg_DepositToSubaccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.sending.Msg/DepositToSubaccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_WithdrawFromSubaccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.sending.Msg/WithdrawFromSubaccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SendFromModuleToAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.sending.Msg/SendFromModuleToAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinxprotocol.sending.Msg",
	...
	Metadata: "jinxprotocol/sending/tx.proto",
}
