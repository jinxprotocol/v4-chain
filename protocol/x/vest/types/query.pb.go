...
// source: jinxprotocol/vest/query.proto
...
func (*QueryVestEntryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_aa2d6955bbf23529, []int{0}
}
...
func (*QueryVestEntryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_aa2d6955bbf23529, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryVestEntryRequest)(nil), "jinxprotocol.vest.QueryVestEntryRequest")
	proto.RegisterType((*QueryVestEntryResponse)(nil), "jinxprotocol.vest.QueryVestEntryResponse")
}

func init() { proto.RegisterFile("jinxprotocol/vest/query.proto", fileDescriptor_aa2d6955bbf23529) }

var fileDescriptor_aa2d6955bbf23529 = []byte{
	...
	0x27, 0xb1, 0x81, 0x85, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x6f, 0x45, 0x71, 0x0f, 0x0f,
	0x02, 0x00, 0x00,
}
...
func (c *queryClient) VestEntry(ctx context.Context, in *QueryVestEntryRequest, opts ...grpc.CallOption) (*QueryVestEntryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.vest.Query/VestEntry", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_VestEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.vest.Query/VestEntry",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinxprotocol.vest.Query",
	...
	Metadata: "jinxprotocol/vest/query.proto",
}
