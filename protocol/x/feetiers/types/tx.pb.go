...
// source: jinxprotocol/feetiers/tx.proto
...
func (*MsgUpdatePerpetualFeeParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_5baceecbfad6b094, []int{0}
}
...
func (*MsgUpdatePerpetualFeeParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5baceecbfad6b094, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdatePerpetualFeeParams)(nil), "jinxprotocol.feetiers.MsgUpdatePerpetualFeeParams")
	proto.RegisterType((*MsgUpdatePerpetualFeeParamsResponse)(nil), "jinxprotocol.feetiers.MsgUpdatePerpetualFeeParamsResponse")
}

func init() { proto.RegisterFile("jinxprotocol/feetiers/tx.proto", fileDescriptor_5baceecbfad6b094) }

var fileDescriptor_5baceecbfad6b094 = []byte{
	// 331 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcb, 0xca, 0xcc, 0xab,
	...
	0x00, 0xff, 0xff, 0xd3, 0x46, 0x4e, 0x74, 0x70, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdatePerpetualFeeParams(ctx context.Context, in *MsgUpdatePerpetualFeeParams, opts ...grpc.CallOption) (*MsgUpdatePerpetualFeeParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.feetiers.Msg/UpdatePerpetualFeeParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdatePerpetualFeeParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.feetiers.Msg/UpdatePerpetualFeeParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinxprotocol.feetiers.Msg",
	...
	Metadata: "jinxprotocol/feetiers/tx.proto",
}
