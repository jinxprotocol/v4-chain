...
// source: jinxprotocol/delaymsg/block_message_ids.proto
...
func (*BlockMessageIds) Descriptor() ([]byte, []int) {
	return fileDescriptor_a07f61a4835edbd3, []int{0}
}
...
func init() {
	proto.RegisterType((*BlockMessageIds)(nil), "jinxprotocol.delaymsg.BlockMessageIds")
}

func init() {
	proto.RegisterFile("jinxprotocol/delaymsg/block_message_ids.proto", fileDescriptor_a07f61a4835edbd3)
}

var fileDescriptor_a07f61a4835edbd3 = []byte{
	...
	0x00, 0xff, 0xff, 0x7c, 0x67, 0x59, 0xfc, 0xc9, 0x00, 0x00, 0x00,
}
