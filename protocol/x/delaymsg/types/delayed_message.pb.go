...
// source: jinxprotocol/delaymsg/delayed_message.proto
...
func (*DelayedMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_8b469df821172c29, []int{0}
}
...
func init() {
	proto.RegisterType((*DelayedMessage)(nil), "jinxprotocol.delaymsg.DelayedMessage")
}

func init() {
	proto.RegisterFile("jinxprotocol/delaymsg/delayed_message.proto", fileDescriptor_8b469df821172c29)
}

var fileDescriptor_8b469df821172c29 = []byte{
	...
	0x00, 0x00, 0xff, 0xff, 0xab, 0x92, 0xab, 0x18, 0x2a, 0x01, 0x00, 0x00,
}
