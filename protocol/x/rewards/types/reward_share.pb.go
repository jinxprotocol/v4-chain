...
// source: jinxprotocol/rewards/reward_share.proto
...
type RewardShare struct {
	...
	Weight  github_com_jinxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=weight,proto3,customtype=github.com/jinxprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"weight"`
}
...
func (*RewardShare) Descriptor() ([]byte, []int) {
	return fileDescriptor_79329a196260d1ab, []int{0}
}
...
func init() {
	proto.RegisterType((*RewardShare)(nil), "jinxprotocol.rewards.RewardShare")
}

func init() {
	proto.RegisterFile("jinxprotocol/rewards/reward_share.proto", fileDescriptor_79329a196260d1ab)
}

var fileDescriptor_79329a196260d1ab = []byte{
	// 258 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0xcf, 0xca, 0xcc, 0xab,
	...
	0x6c, 0x60, 0x19, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x86, 0xc4, 0x32, 0xee, 0x73, 0x01,
	0x00, 0x00,
}
