...
// source: jinxprotocol/prices/market_price.proto
...
func (*MarketPrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_f8a051b4965c4cf1, []int{0}
}
...
func init() {
	proto.RegisterType((*MarketPrice)(nil), "jinxprotocol.prices.MarketPrice")
}

func init() {
	proto.RegisterFile("jinxprotocol/prices/market_price.proto", fileDescriptor_f8a051b4965c4cf1)
}

var fileDescriptor_f8a051b4965c4cf1 = []byte{
	...
	0x06, 0x96, 0x30, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x10, 0x9d, 0x4b, 0x74, 0xea, 0x00, 0x00,
	0x00,
}
