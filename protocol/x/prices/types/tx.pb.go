...
// source: jinxprotocol/prices/tx.proto
...
func (*MsgCreateOracleMarket) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5553668386a82a, []int{0}
}
...
func (*MsgCreateOracleMarketResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5553668386a82a, []int{1}
}
...
func (*MsgUpdateMarketPrices) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5553668386a82a, []int{2}
}
...
func (*MsgUpdateMarketPrices_MarketPrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5553668386a82a, []int{2, 0}
}
...
func (*MsgUpdateMarketPricesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5553668386a82a, []int{3}
}
...
func (*MsgUpdateMarketParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5553668386a82a, []int{4}
}
...
func (*MsgUpdateMarketParamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5553668386a82a, []int{5}
}
...
func init() {
	proto.RegisterType((*MsgCreateOracleMarket)(nil), "jinxprotocol.prices.MsgCreateOracleMarket")
	proto.RegisterType((*MsgCreateOracleMarketResponse)(nil), "jinxprotocol.prices.MsgCreateOracleMarketResponse")
	proto.RegisterType((*MsgUpdateMarketPrices)(nil), "jinxprotocol.prices.MsgUpdateMarketPrices")
	proto.RegisterType((*MsgUpdateMarketPrices_MarketPrice)(nil), "jinxprotocol.prices.MsgUpdateMarketPrices.MarketPrice")
	proto.RegisterType((*MsgUpdateMarketPricesResponse)(nil), "jinxprotocol.prices.MsgUpdateMarketPricesResponse")
	proto.RegisterType((*MsgUpdateMarketParam)(nil), "jinxprotocol.prices.MsgUpdateMarketParam")
	proto.RegisterType((*MsgUpdateMarketParamResponse)(nil), "jinxprotocol.prices.MsgUpdateMarketParamResponse")
}

func init() { proto.RegisterFile("jinxprotocol/prices/tx.proto", fileDescriptor_ad5553668386a82a) }

var fileDescriptor_ad5553668386a82a = []byte{
	// 491 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xc9, 0xca, 0xcc, 0xab,
	...
	0x00, 0xff, 0xff, 0x7b, 0xca, 0x8c, 0xd7, 0xde, 0x04, 0x00, 0x00,
}
...
func (c *msgClient) UpdateMarketPrices(ctx context.Context, in *MsgUpdateMarketPrices, opts ...grpc.CallOption) (*MsgUpdateMarketPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.prices.Msg/UpdateMarketPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CreateOracleMarket(ctx context.Context, in *MsgCreateOracleMarket, opts ...grpc.CallOption) (*MsgCreateOracleMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.prices.Msg/CreateOracleMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateMarketParam(ctx context.Context, in *MsgUpdateMarketParam, opts ...grpc.CallOption) (*MsgUpdateMarketParamResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.prices.Msg/UpdateMarketParam", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateMarketPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.prices.Msg/UpdateMarketPrices",
	}
...
func _Msg_CreateOracleMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.prices.Msg/CreateOracleMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateMarketParam_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.prices.Msg/UpdateMarketParam",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinxprotocol.prices.Msg",
	...
	Metadata: "jinxprotocol/prices/tx.proto",
}
