...
// source: jinxprotocol/clob/liquidations.proto
...
func (*PerpetualLiquidationInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_b654658b92eb31f3, []int{0}
}
...
func (*SubaccountLiquidationInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_b654658b92eb31f3, []int{1}
}
...
func (*SubaccountOpenPositionInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_b654658b92eb31f3, []int{2}
}
...
func init() {
	proto.RegisterType((*PerpetualLiquidationInfo)(nil), "jinxprotocol.clob.PerpetualLiquidationInfo")
	proto.RegisterType((*SubaccountLiquidationInfo)(nil), "jinxprotocol.clob.SubaccountLiquidationInfo")
	proto.RegisterType((*SubaccountOpenPositionInfo)(nil), "jinxprotocol.clob.SubaccountOpenPositionInfo")
}

func init() {
	proto.RegisterFile("jinxprotocol/clob/liquidations.proto", fileDescriptor_b654658b92eb31f3)
}

var fileDescriptor_b654658b92eb31f3 = []byte{
	// 414 bytes of a gzipped FileDescriptorProto
	,
}
