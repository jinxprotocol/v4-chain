...
// source: jinxprotocol/clob/order.proto
...
import (
	...
	types "github.com/jinxprotocol/v4-chain/protocol/x/subaccounts/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
func (Order_Side) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{7, 0}
}
...
func (Order_TimeInForce) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{7, 1}
}
...
func (Order_ConditionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{7, 2}
}
...
func (*OrderId) Descriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{0}
}
...
func (*OrdersFilledDuringLatestBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{1}
}
...
func (*PotentiallyPrunableOrders) Descriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{2}
}
...
func (*OrderFillState) Descriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{3}
}
...
func (*StatefulOrderTimeSliceValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{4}
}
...
func (*LongTermOrderPlacement) Descriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{5}
}
...
func (*ConditionalOrderPlacement) Descriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{6}
}
...
type Order struct {
	...
	Side    Order_Side `protobuf:"varint,2,opt,name=side,proto3,enum=jinxprotocol.clob.Order_Side" json:"side,omitempty"`
	...
	TimeInForce Order_TimeInForce `protobuf:"varint,7,opt,name=time_in_force,json=timeInForce,proto3,enum=jinxprotocol.clob.Order_TimeInForce" json:"time_in_force,omitempty"`
	...
	ConditionType  Order_ConditionType `protobuf:"varint,10,opt,name=condition_type,json=conditionType,proto3,enum=jinxprotocol.clob.Order_ConditionType" json:"condition_type,omitempty"`
...
func (*Order) Descriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{7}
}
...
func (*TransactionOrdering) Descriptor() ([]byte, []int) {
	return fileDescriptor_1306d5f40d94718a, []int{8}
}
...
func init() {
	proto.RegisterEnum("jinxprotocol.clob.Order_Side", Order_Side_name, Order_Side_value)
	proto.RegisterEnum("jinxprotocol.clob.Order_TimeInForce", Order_TimeInForce_name, Order_TimeInForce_value)
	proto.RegisterEnum("jinxprotocol.clob.Order_ConditionType", Order_ConditionType_name, Order_ConditionType_value)
	proto.RegisterType((*OrderId)(nil), "jinxprotocol.clob.OrderId")
	proto.RegisterType((*OrdersFilledDuringLatestBlock)(nil), "jinxprotocol.clob.OrdersFilledDuringLatestBlock")
	proto.RegisterType((*PotentiallyPrunableOrders)(nil), "jinxprotocol.clob.PotentiallyPrunableOrders")
	proto.RegisterType((*OrderFillState)(nil), "jinxprotocol.clob.OrderFillState")
	proto.RegisterType((*StatefulOrderTimeSliceValue)(nil), "jinxprotocol.clob.StatefulOrderTimeSliceValue")
	proto.RegisterType((*LongTermOrderPlacement)(nil), "jinxprotocol.clob.LongTermOrderPlacement")
	proto.RegisterType((*ConditionalOrderPlacement)(nil), "jinxprotocol.clob.ConditionalOrderPlacement")
	proto.RegisterType((*Order)(nil), "jinxprotocol.clob.Order")
	proto.RegisterType((*TransactionOrdering)(nil), "jinxprotocol.clob.TransactionOrdering")
}

func init() { proto.RegisterFile("jinxprotocol/clob/order.proto", fileDescriptor_1306d5f40d94718a) }

var fileDescriptor_1306d5f40d94718a = []byte{
	...
	,
}
