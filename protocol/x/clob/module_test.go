...
import (
	...
	clob_keeper "github.com/jinxprotocol/v4-chain/protocol/x/clob/keeper"
	"github.com/jinxprotocol/v4-chain/protocol/x/clob/memclob"
	clob_types "github.com/jinxprotocol/v4-chain/protocol/x/clob/types"
	"github.com/jinxprotocol/v4-chain/protocol/x/perpetuals"
	perp_keeper "github.com/jinxprotocol/v4-chain/protocol/x/perpetuals/keeper"
...
func TestAppModuleBasic_RegisterGRPCGatewayRoutes(t *testing.T) {
	...
	req, err := http.NewRequest("GET", "/jinxprotocol/clob/clob_pair", nil)
	require.NoError(t, err)
	...
	recorder = httptest.NewRecorder()
	req, err = http.NewRequest("GET", "/jinxprotocol/clob/clob_pair/0", nil)
	require.NoError(t, err)
	router.ServeHTTP(recorder, req)
	require.Contains(t, recorder.Body.String(), "no RPC client is defined in offline mode")
