...
// source: jinxprotocol/ratelimit/capacity.proto
...
type DenomCapacity struct {
	...
	// `LimitParams`.
	CapacityList []github_com_jinxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,rep,name=capacity_list,json=capacityList,proto3,customtype=github.com/jinxprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"capacity_list"`
}
...
func (*DenomCapacity) Descriptor() ([]byte, []int) {
	return fileDescriptor_752bc9a53fe68a1a, []int{0}
}
...
func init() {
	proto.RegisterType((*DenomCapacity)(nil), "jinxprotocol.ratelimit.DenomCapacity")
}

func init() {
	proto.RegisterFile("jinxprotocol/ratelimit/capacity.proto", fileDescriptor_752bc9a53fe68a1a)
}

var fileDescriptor_752bc9a53fe68a1a = []byte{
	// 233 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0xcd, 0xca, 0xcc, 0xab,
	...
	0xff, 0x14, 0xd5, 0xd8, 0x7c, 0x4b, 0x01, 0x00, 0x00,
}
...
func (m *DenomCapacity) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			var v github_com_jinxprotocol_v4_chain_protocol_dtypes.SerializableInt
