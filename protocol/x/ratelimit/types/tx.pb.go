...
// source: jinxprotocol/ratelimit/tx.proto
...
func (*MsgSetLimitParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd858218393ccf55, []int{0}
}
...
func (*MsgSetLimitParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd858218393ccf55, []int{1}
}
...
func (*MsgDeleteLimitParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd858218393ccf55, []int{2}
}
...
func (*MsgDeleteLimitParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd858218393ccf55, []int{3}
}
...
func init() {
	proto.RegisterType((*MsgSetLimitParams)(nil), "jinxprotocol.ratelimit.MsgSetLimitParams")
	proto.RegisterType((*MsgSetLimitParamsResponse)(nil), "jinxprotocol.ratelimit.MsgSetLimitParamsResponse")
	proto.RegisterType((*MsgDeleteLimitParams)(nil), "jinxprotocol.ratelimit.MsgDeleteLimitParams")
	proto.RegisterType((*MsgDeleteLimitParamsResponse)(nil), "jinxprotocol.ratelimit.MsgDeleteLimitParamsResponse")
}

func init() { proto.RegisterFile("jinxprotocol/ratelimit/tx.proto", fileDescriptor_cd858218393ccf55) }

var fileDescriptor_cd858218393ccf55 = []byte{
	// 333 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcf, 0xca, 0xcc, 0xab,
	...
	0x04, 0x00, 0x00, 0xff, 0xff, 0x46, 0xc2, 0xe9, 0x87, 0xf2, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) SetLimitParams(ctx context.Context, in *MsgSetLimitParams, opts ...grpc.CallOption) (*MsgSetLimitParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.ratelimit.Msg/SetLimitParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteLimitParams(ctx context.Context, in *MsgDeleteLimitParams, opts ...grpc.CallOption) (*MsgDeleteLimitParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.ratelimit.Msg/DeleteLimitParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetLimitParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.ratelimit.Msg/SetLimitParams",
	}
...
func _Msg_DeleteLimitParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.ratelimit.Msg/DeleteLimitParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinxprotocol.ratelimit.Msg",
	...
	Metadata: "jinxprotocol/ratelimit/tx.proto",
}
