...
// source: jinxprotocol/blocktime/params.proto
...
func (*DowntimeParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_b2bdde629ee37360, []int{0}
}
...
func init() {
	proto.RegisterType((*DowntimeParams)(nil), "jinxprotocol.blocktime.DowntimeParams")
}

func init() {
	proto.RegisterFile("jinxprotocol/blocktime/params.proto", fileDescriptor_b2bdde629ee37360)
}

var fileDescriptor_b2bdde629ee37360 = []byte{
	...
	0x20, 0x00, 0x00, 0xff, 0xff, 0x55, 0x3d, 0xae, 0xbb, 0x27, 0x01, 0x00, 0x00,
}
