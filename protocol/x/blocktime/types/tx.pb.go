...
// source: jinxprotocol/blocktime/tx.proto
...
func (*MsgUpdateDowntimeParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_c945503a1b7ded09, []int{0}
}
...
func (*MsgUpdateDowntimeParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c945503a1b7ded09, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateDowntimeParams)(nil), "jinxprotocol.blocktime.MsgUpdateDowntimeParams")
	proto.RegisterType((*MsgUpdateDowntimeParamsResponse)(nil), "jinxprotocol.blocktime.MsgUpdateDowntimeParamsResponse")
}

func init() { proto.RegisterFile("jinxprotocol/blocktime/tx.proto", fileDescriptor_c945503a1b7ded09) }

var fileDescriptor_c945503a1b7ded09 = []byte{
	...
	0x59, 0x90, 0x5a, 0x9c, 0xc4, 0x06, 0x96, 0x33, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xb1, 0x2b,
	0x07, 0x93, 0x5f, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateDowntimeParams(ctx context.Context, in *MsgUpdateDowntimeParams, opts ...grpc.CallOption) (*MsgUpdateDowntimeParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.blocktime.Msg/UpdateDowntimeParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateDowntimeParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.blocktime.Msg/UpdateDowntimeParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinxprotocol.blocktime.Msg",
	...
	Metadata: "jinxprotocol/blocktime/tx.proto",
}
