...
// source: jinxprotocol/blocktime/query.proto
...
func (*QueryDowntimeParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed04f18c346eff9b, []int{0}
}
...
func (*QueryDowntimeParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed04f18c346eff9b, []int{1}
}
...
func (*QueryPreviousBlockInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed04f18c346eff9b, []int{2}
}
...
func (*QueryPreviousBlockInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed04f18c346eff9b, []int{3}
}
...
func (*QueryAllDowntimeInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed04f18c346eff9b, []int{4}
}
...
func (*QueryAllDowntimeInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed04f18c346eff9b, []int{5}
}
...
func init() {
	proto.RegisterType((*QueryDowntimeParamsRequest)(nil), "jinxprotocol.blocktime.QueryDowntimeParamsRequest")
	proto.RegisterType((*QueryDowntimeParamsResponse)(nil), "jinxprotocol.blocktime.QueryDowntimeParamsResponse")
	proto.RegisterType((*QueryPreviousBlockInfoRequest)(nil), "jinxprotocol.blocktime.QueryPreviousBlockInfoRequest")
	proto.RegisterType((*QueryPreviousBlockInfoResponse)(nil), "jinxprotocol.blocktime.QueryPreviousBlockInfoResponse")
	proto.RegisterType((*QueryAllDowntimeInfoRequest)(nil), "jinxprotocol.blocktime.QueryAllDowntimeInfoRequest")
	proto.RegisterType((*QueryAllDowntimeInfoResponse)(nil), "jinxprotocol.blocktime.QueryAllDowntimeInfoResponse")
}

func init() {
	proto.RegisterFile("jinxprotocol/blocktime/query.proto", fileDescriptor_ed04f18c346eff9b)
}

var fileDescriptor_ed04f18c346eff9b = []byte{
	// 420 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0xca, 0xca, 0xcc, 0xab,
	...
	0x16, 0x27, 0xb1, 0x81, 0xe5, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x54, 0x6f, 0xd3, 0x18,
	0x52, 0x04, 0x00, 0x00,
}
...
func (c *queryClient) DowntimeParams(ctx context.Context, in *QueryDowntimeParamsRequest, opts ...grpc.CallOption) (*QueryDowntimeParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.blocktime.Query/DowntimeParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PreviousBlockInfo(ctx context.Context, in *QueryPreviousBlockInfoRequest, opts ...grpc.CallOption) (*QueryPreviousBlockInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.blocktime.Query/PreviousBlockInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllDowntimeInfo(ctx context.Context, in *QueryAllDowntimeInfoRequest, opts ...grpc.CallOption) (*QueryAllDowntimeInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.blocktime.Query/AllDowntimeInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_DowntimeParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.blocktime.Query/DowntimeParams",
	}
...
func _Query_PreviousBlockInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.blocktime.Query/PreviousBlockInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AllDowntimeInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.blocktime.Query/AllDowntimeInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinxprotocol.blocktime.Query",
	...
	Metadata: "jinxprotocol/blocktime/query.proto",
}
