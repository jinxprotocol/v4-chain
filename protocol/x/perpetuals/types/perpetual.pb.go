...
// source: jinxprotocol/perpetuals/perpetual.proto
...
type Perpetual struct {
	...
	FundingIndex github_com_jinxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=funding_index,json=fundingIndex,proto3,customtype=github.com/jinxprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"funding_index"`
}
...
func (*Perpetual) Descriptor() ([]byte, []int) {
	return fileDescriptor_26d3db56ff3eb373, []int{0}
}
...
func (*PerpetualParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_26d3db56ff3eb373, []int{1}
}
...
func (*MarketPremiums) Descriptor() ([]byte, []int) {
	return fileDescriptor_26d3db56ff3eb373, []int{2}
}
...
func (*PremiumStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_26d3db56ff3eb373, []int{3}
}
...
func (*LiquidityTier) Descriptor() ([]byte, []int) {
	return fileDescriptor_26d3db56ff3eb373, []int{4}
}
...
func init() {
	proto.RegisterType((*Perpetual)(nil), "jinxprotocol.perpetuals.Perpetual")
	proto.RegisterType((*PerpetualParams)(nil), "jinxprotocol.perpetuals.PerpetualParams")
	proto.RegisterType((*MarketPremiums)(nil), "jinxprotocol.perpetuals.MarketPremiums")
	proto.RegisterType((*PremiumStore)(nil), "jinxprotocol.perpetuals.PremiumStore")
	proto.RegisterType((*LiquidityTier)(nil), "jinxprotocol.perpetuals.LiquidityTier")
}

func init() {
	proto.RegisterFile("jinxprotocol/perpetuals/perpetual.proto", fileDescriptor_26d3db56ff3eb373)
}

var fileDescriptor_26d3db56ff3eb373 = []byte{
	// 593 bytes of a gzipped FileDescriptorProto
	,
}
