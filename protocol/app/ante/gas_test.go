...
import (
	...
	"github.com/jinxprotocol/v4-chain/protocol/app/ante"
...
func TestSubmitTxnWithGas(t *testing.T) {
	tests := map[string]struct {
		...
		"Failure: 0 gas fee": {
			...
			logMessage: "insufficient fees; got:  required: 25000000000000000jinx," +
		...
		"Failure: unsupported gas fee denom": {
			...
			responseCode: sdkerrors.ErrInsufficientFee.ABCICode(),
			logMessage: "insufficient fees; got: 100000000btc-denom required: 25000000000000000jinx," +
				"25000ibc/8E27BA2D5493AF5636760E354E46004562C46AB7EC0CC4C1CA14E9E20E2545B5: insufficient fee",
		},
	}
	for name, tc := range tests {
