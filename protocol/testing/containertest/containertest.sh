...
download_preupgrade_binary() {
	...
	tar_url="https://github.com/jinxprotocol/v4-chain/releases/download/protocol%2F$PREUPGRADE_VERSION/jinxprotocold-$PREUPGRADE_VERSION-linux-$url_arch.tar.gz"
	tar_path='/tmp/jinxprotocold/jinxprotocold.tar.gz'
	mkdir -p /tmp/jinxprotocold
	curl -vL $tar_url -o $tar_path
	jinxprotocold_path=$(tar -xvf $tar_path --directory /tmp/jinxprotocold)
	cp /tmp/jinxprotocold/$jinxprotocold_path /bin/jinxprotocold_preupgrade
}
