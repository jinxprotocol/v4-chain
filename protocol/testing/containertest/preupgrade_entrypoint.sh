...
rm "$DAEMON_HOME/cosmovisor/genesis/bin/jinxprotocold"
ln -s /bin/jinxprotocold_preupgrade "$DAEMON_HOME/cosmovisor/genesis/bin/jinxprotocold"
mkdir -p "$DAEMON_HOME/cosmovisor/upgrades/$UPGRADE_TO_VERSION/bin/"
ln -s /bin/jinxprotocold "$DAEMON_HOME/cosmovisor/upgrades/$UPGRADE_TO_VERSION/bin/jinxprotocold"
