...
// source: jinxprotocol/daemons/bridge/bridge.proto
...
import (
	...
	types "github.com/jinxprotocol/v4-chain/protocol/x/bridge/types"
...
func (*AddBridgeEventsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ba47eb41791c4e9, []int{0}
}
...
func (*AddBridgeEventsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8ba47eb41791c4e9, []int{1}
}
...
func init() {
	proto.RegisterType((*AddBridgeEventsRequest)(nil), "jinxprotocol.daemons.bridge.AddBridgeEventsRequest")
	proto.RegisterType((*AddBridgeEventsResponse)(nil), "jinxprotocol.daemons.bridge.AddBridgeEventsResponse")
}

func init() {
	proto.RegisterFile("jinxprotocol/daemons/bridge/bridge.proto", fileDescriptor_8ba47eb41791c4e9)
}

var fileDescriptor_8ba47eb41791c4e9 = []byte{
	// 261 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xd2, 0xc8, 0xca, 0xcc, 0xab,
	...
	0x05, 0x99, 0x49, 0x6c, 0x60, 0x49, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xd4, 0xf2, 0x07,
	0x1f, 0xf7, 0x01, 0x00, 0x00,
}
...
func (c *bridgeServiceClient) AddBridgeEvents(ctx context.Context, in *AddBridgeEventsRequest, opts ...grpc.CallOption) (*AddBridgeEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.daemons.bridge.BridgeService/AddBridgeEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BridgeService_AddBridgeEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.daemons.bridge.BridgeService/AddBridgeEvents",
	}
...
var _BridgeService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinxprotocol.daemons.bridge.BridgeService",
	...
	Metadata: "jinxprotocol/daemons/bridge/bridge.proto",
}
