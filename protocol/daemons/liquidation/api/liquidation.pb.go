...
// source: jinxprotocol/daemons/liquidation/liquidation.proto
...
import (
	...
	types1 "github.com/jinxprotocol/v4-chain/protocol/x/clob/types"
...
func (*LiquidateSubaccountsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e03700c0b6f7549a, []int{0}
}
...
func (*LiquidateSubaccountsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e03700c0b6f7549a, []int{1}
}
...
func init() {
	proto.RegisterType((*LiquidateSubaccountsRequest)(nil), "jinxprotocol.daemons.liquidation.LiquidateSubaccountsRequest")
	proto.RegisterType((*LiquidateSubaccountsResponse)(nil), "jinxprotocol.daemons.liquidation.LiquidateSubaccountsResponse")
}

func init() {
	proto.RegisterFile("jinxprotocol/daemons/liquidation/liquidation.proto", fileDescriptor_e03700c0b6f7549a)
}

var fileDescriptor_e03700c0b6f7549a = []byte{
	...
	,
}
...
func (c *liquidationServiceClient) LiquidateSubaccounts(ctx context.Context, in *LiquidateSubaccountsRequest, opts ...grpc.CallOption) (*LiquidateSubaccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinxprotocol.daemons.liquidation.LiquidationService/LiquidateSubaccounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LiquidationService_LiquidateSubaccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinxprotocol.daemons.liquidation.LiquidationService/LiquidateSubaccounts",
	}
...
var _LiquidationService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinxprotocol.daemons.liquidation.LiquidationService",
	...
	Metadata: "jinxprotocol/daemons/liquidation/liquidation.proto",
}
