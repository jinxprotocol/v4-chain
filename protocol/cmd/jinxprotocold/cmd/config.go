...
const (
	...
	// TODO(GENESIS): `jinx` is a placeholder for the stake token of the jInX chain.
	// Before this software is published for genesis, `jinx` should be replaced with
	...
	minGasPriceStakeToken = "25000000000jinx"
...
// JinxAppConfig specifies jInX app specific config.
type JinxAppConfig struct {
	serverconfig.Config
}
...
func initAppConfig() (string, *JinxAppConfig) {
...
func initTendermintConfig() *tmcfg.Config {
	...
	// (https://github.com/jinxprotocol/tendermint/blob/dc03b21cf5d54c641e1d14b14fae5920fa7ba656/config/config.go#L982)
