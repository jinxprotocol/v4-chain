	...
	tests := map[string]struct {
		...
		"Success: event ID 0": {
			...
			expectedEvent: bridgetypes.BridgeEvent{
				...
				Address:        "jinx1qqgzqvzq2ps8pqys5zcvp58q7rluextxzepsan",
		...
		"Success: event ID 1 - empty address": {
			...
			expectedEvent: bridgetypes.BridgeEvent{
				...
				Address:        "jinx1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqaffu92",
		...
		"Success: event ID 2": {
			...
			expectedEvent: bridgetypes.BridgeEvent{
				...
				Address:        "jinx1qqgzqvzq2ps8pqys5zcvp58q7rluextxzy3rx3z4vemc3xgq42asksu05f",
		...
		"Success: event ID 3": {
			...
			expectedEvent: bridgetypes.BridgeEvent{
				...
				Address:        "jinx124n92ej4ve2kv4tx24n92ej4ve2kv4tx24n92ej4ve2kv4tx24nq5un47j",
		...
		"Success: event ID 4": {
			...
			expectedEvent: bridgetypes.BridgeEvent{
				...
				// address shorter than 20 bytes is padded with zeros.
				Address:        "jinx1zg6pydqqqqqqqqqqqqqqqqqqqqqqqqqquuynpa",
