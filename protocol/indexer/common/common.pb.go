...
// source: jinxprotocol/indexer/common/common.proto
...
func init() {
	proto.RegisterEnum("jinxprotocol.indexer.common.OrderRemovalReason", OrderRemovalReason_name, OrderRemovalReason_value)
}

func init() {
	proto.RegisterFile("jinxprotocol/indexer/common/common.proto", fileDescriptor_cc7f22a39c006b65)
}
