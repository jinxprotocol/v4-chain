...
// source: jinxprotocol/indexer/protocol/v1/subaccount.proto
...
func (*IndexerSubaccountId) Descriptor() ([]byte, []int) {
	return fileDescriptor_7151886a2bbdc651, []int{0}
}
...
type IndexerPerpetualPosition struct {
	...
	Quantums github_com_jinxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=quantums,proto3,customtype=github.com/jinxprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"quantums"`
	...
	FundingPayment github_com_jinxprotocol_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=funding_payment,json=fundingPayment,proto3,customtype=github.com/jinxprotocol/v4-chain/protocol/dtypes.SerializableInt" json:"funding_payment"`
}
...
func (*IndexerPerpetualPosition) Descriptor() ([]byte, []int) {
	return fileDescriptor_7151886a2bbdc651, []int{1}
}
...
func (*IndexerAssetPosition) Descriptor() ([]byte, []int) {
	return fileDescriptor_7151886a2bbdc651, []int{2}
}
...
func init() {
	proto.RegisterType((*IndexerSubaccountId)(nil), "jinxprotocol.indexer.protocol.v1.IndexerSubaccountId")
	proto.RegisterType((*IndexerPerpetualPosition)(nil), "jinxprotocol.indexer.protocol.v1.IndexerPerpetualPosition")
	proto.RegisterType((*IndexerAssetPosition)(nil), "jinxprotocol.indexer.protocol.v1.IndexerAssetPosition")
}

func init() {
	proto.RegisterFile("jinxprotocol/indexer/protocol/v1/subaccount.proto", fileDescriptor_7151886a2bbdc651)
}

var fileDescriptor_7151886a2bbdc651 = []byte{
	...
	,
}
