...
test-sim-custom-genesis-fast:
	...
	@echo "By default, ${HOME}/.jinxprotocol/config/genesis.json will be used."
	@go test -mod=readonly -tags '$(build_tags)' $(SIMAPP) -run TestFullAppSimulation -Genesis=${HOME}/.jinxprotocol/config/genesis.json \
...
test-sim-custom-genesis-multi-seed: runsim
	...
	@echo "By default, ${HOME}/.jinxprotocol/config/genesis.json will be used."
	@$(BINDIR)/runsim -Genesis=${HOME}/.jinxprotocol/config/genesis.json -SimAppPkg=$(SIMAPP) -ExitOnFail 400 5 'TestFullAppSimulation -tags $(build_tags)'
