...
export enum OrderPlaceV1_OrderPlacementStatus {
  ...
  /**
   * ORDER_PLACEMENT_STATUS_OPENED - An opened order is one that is confirmed to be placed on all jInX nodes
...
export enum OrderRemoveV1_OrderRemovalStatus {
  ...
  /**
   * ORDER_REMOVAL_STATUS_CANCELED - A canceled order is one that is confirmed to be removed on all jInX nodes
