...
export class QueryClientImpl implements Query {
  ...
  subaccount(request: QueryGetSubaccountRequest): Promise<QuerySubaccountResponse> {
    ...
    const promise = this.rpc.request("jinxprotocol.subaccounts.Query", "Subaccount", data);
  ...
  subaccountAll(request: QueryAllSubaccountRequest = {
    ...
    const promise = this.rpc.request("jinxprotocol.subaccounts.Query", "SubaccountAll", data);
