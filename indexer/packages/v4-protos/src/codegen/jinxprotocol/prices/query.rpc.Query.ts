...
export class QueryClientImpl implements Query {
  ...
  marketPrice(request: QueryMarketPriceRequest): Promise<QueryMarketPriceResponse> {
    ...
    const promise = this.rpc.request("jinxprotocol.prices.Query", "MarketPrice", data);
  ...
  allMarketPrices(request: QueryAllMarketPricesRequest = {
    ...
    const promise = this.rpc.request("jinxprotocol.prices.Query", "AllMarketPrices", data);
  ...
  marketParam(request: QueryMarketParamRequest): Promise<QueryMarketParamResponse> {
    ...
    const promise = this.rpc.request("jinxprotocol.prices.Query", "MarketParam", data);
  ...
  allMarketParams(request: QueryAllMarketParamsRequest = {
    ...
    const promise = this.rpc.request("jinxprotocol.prices.Query", "AllMarketParams", data);
