CREATE OR REPLACE FUNCTION jinx_get_weighted_average(first_price numeric, first_weight numeric, second_price numeric, second_weight numeric) RETURNS numeric AS $$
/**
...
*/
BEGIN
    RETURN jinx_trim_scale((coalesce(first_price, 0::numeric) * first_weight +
