CREATE OR REPLACE FUNCTION jinx_protocol_condition_type_to_order_type(condition_type jsonb) RETURNS text AS $$
/**
  Converts the 'ConditionType' enum from the IndexerOrder protobuf (https://github.com/jinxprotocol/v4-chain/blob/9ed26bd/proto/jinxprotocol/indexer/protocol/v1/clob.proto#L130)
