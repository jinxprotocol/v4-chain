CREATE OR REPLACE FUNCTION jinx_event_id_from_parts(block_height int, transaction_index int, event_index int) RETURNS bytea AS $$
/**
...
BEGIN
    ...
    See https://github.com/jinxprotocol/v4-chain/blob/9ed26bd/indexer/packages/postgres/src/stores/tendermint-event-table.ts#L34
    */
