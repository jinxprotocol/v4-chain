CREATE OR REPLACE FUNCTION jinx_from_serializable_int(serializable_int jsonb) RETURNS numeric AS $$
/**
  Converts a JSON.stringify byte array representing a SerializableInt
  (https://github.com/jinxprotocol/v4-chain/blob/9ed26bd/protocol/dtypes/serializable_int.go#L84) to a numeric.
