CREATE OR REPLACE FUNCTION jinx_from_protocol_time_in_force(tif jsonb) RETURNS text AS $$
/**
  Converts the TimeInForce field from an IndexerOrder proto (https://github.com/jinxprotocol/v4-chain/blob/9ed26bd/proto/jinxprotocol/indexer/protocol/v1/clob.proto#L94)
