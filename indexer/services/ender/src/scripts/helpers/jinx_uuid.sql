CREATE OR REPLACE FUNCTION jinx_uuid(name text) RETURNS uuid AS $$
/**
  Computes a UUID using a well known namespace.

  The namespace must match the well known constant defined in
  https://github.com/jinxprotocol/indexer/blob/6aafb97/packages/postgres/src/helpers/uuid.ts#L4.
