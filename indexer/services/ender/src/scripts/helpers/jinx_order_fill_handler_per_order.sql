CREATE OR REPLACE FUNCTION jinx_order_fill_handler_per_order(
...
BEGIN
    ...
    */
    ...
    IF FOUND THEN
        ...
        order_record."status" = jinx_get_order_status(total_filled, order_record.size, order_canceled_status, order_record."orderFlags", order_record."timeInForce");
    ...
    ELSE
        ...
        order_record."status" = jinx_get_order_status(fill_amount, order_size, order_canceled_status, order_record."orderFlags", order_record."timeInForce");
    ...
    perpetual_position_record = jinx_update_perpetual_position_aggregate_fields(
            subaccount_uuid,
