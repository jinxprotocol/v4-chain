CREATE OR REPLACE FUNCTION jinx_asset_create_handler(event_data jsonb) RETURNS jsonb AS $$
/**
  Parameters:
    - event_data: The 'data' field of the IndexerTendermintEvent (https://github.com/jinxprotocol/v4-proto/blob/8d35c86/jinxprotocol/indexer/indexer_manager/event.proto#L25)
        converted to JSON format. Conversion to JSON is expected to be done by JSON.stringify.
  Returns: JSON object containing fields:
    - asset: The created asset in asset-model format (https://github.com/jinxprotocol/indexer/blob/cc70982/packages/postgres/src/models/asset-model.ts).
