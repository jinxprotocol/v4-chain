CREATE OR REPLACE FUNCTION jinx_market_create_handler(event_data jsonb) RETURNS jsonb AS $$
/**
  Parameters:
  ...
  Returns: JSON object containing fields:
    - market: The created market in market-model format (https://github.com/jinxprotocol/v4-chain/blob/9ed26bd/indexer/packages/postgres/src/models/market-model.ts).
