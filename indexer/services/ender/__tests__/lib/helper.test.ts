import { IndexerTendermintEvent, IndexerTendermintEvent_BlockEvent } from '@jinxprotocol-indexer/v4-protos';
import { ParseMessageError } from '@jinxprotocol-indexer/base';
