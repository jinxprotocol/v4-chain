...
describe('syncHandler', () => {
  describe('addHandler/process', () => {
    it('successfully adds handler', async () => {
      ...
      syncHandlers.addHandler(JinxIndexerSubtypes.MARKET, firstHandler);
      syncHandlers.addHandler(JinxIndexerSubtypes.ASSET, secondHandler);
      // should be ignored, because transfers are not handled by syncHandlers
      syncHandlers.addHandler(JinxIndexerSubtypes.TRANSFER, handlerNotInvoked);
