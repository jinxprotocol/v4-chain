...
jInX offers a WebSocket API for streaming v4 updates.

You can connect to the v4 Testnet's webSockets at: `wss://indexer.v4testnet.jinx.exchange/v4/ws`
...
```tsx
wscli connect wss://indexer.v4testnet.jinx.exchange/v4/ws
<output from ws-cli>
...
```tsx
{
  ...
  "id": "jinx199tqg4wdlnu4qjlxchpd7seg454937hjrknju4/0",
  "contents": {
    "subaccount": {
...
```tsx
{
  ...
  "message_id": 4,
  "id": "jinx1zsw8fczav25uvc8rg3zcv6zy9j7yhnktpq374m/0",
  "channel": "v4_subaccounts",
  "version": "2.1.0",
  "contents": {
    "orders": [
