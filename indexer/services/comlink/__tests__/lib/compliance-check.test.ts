...
import { blockedComplianceData, nonBlockedComplianceData } from '@jinxprotocol-indexer/postgres/build/__tests__/helpers/constants';
import request from 'supertest';
import { INDEXER_COMPLIANCE_BLOCKED_PAYLOAD } from '@jinxprotocol-indexer/compliance';
